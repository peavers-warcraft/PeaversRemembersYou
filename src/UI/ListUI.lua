...
local function CreateRow(content)
    ...
    row:SetScript("OnEnter", function(self)
        ...
        GameTooltip:AddDoubleLine("First met", date("%Y-%m-%d %H:%M", self.entryData.firstSeen) --[[@as string]], 0.8, 0.8, 0.8, 1, 1, 1)
        GameTooltip:AddDoubleLine("Last grouped", date("%Y-%m-%d %H:%M", self.entryData.lastSeen) --[[@as string]], 0.8, 0.8, 0.8, 1, 1, 1)
