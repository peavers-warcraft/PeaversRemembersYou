...
local function CreateRow(content)
    ...
    row:SetScript("OnEnter", function(self)
        ...
        GameTooltip:AddDoubleLine("First met", tostring(date("%Y-%m-%d %H:%M", self.entryData.firstSeen)), 0.8, 0.8, 0.8, 1, 1, 1)
        GameTooltip:AddDoubleLine("Last grouped", tostring(date("%Y-%m-%d %H:%M", self.entryData.lastSeen)), 0.8, 0.8, 0.8, 1, 1, 1)
