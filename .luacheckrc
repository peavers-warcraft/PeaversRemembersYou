-- PeaversRemembersYou luacheck config. Thin wrapper over the shared Peavers base (../wow-api).
...
for _, g in ipairs({"PeaversRemembersYouDB"}) do globals[#globals + 1] = g end
